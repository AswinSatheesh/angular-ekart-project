...
export class ProductListComponent{
  ...
  products = [
    {
      ...
      description: "Step into comfort and style with our collection of versatile shoes, designed to cater to both men and women. Whether you're heading out for a casual day out or gearing up for a high-energy workout, our shoes offer the perfect blend of functionality and fashion.",
      brand: "NIKE",
      gender: "MEN",
      category: "RUNNING",
      size: [6, 7, 8, 9, 10],
    ...
    },
    {
      ...
      category: "RUNNING",
      size: [6, 7, 8, 9, 10],
      color: ["Yellow", "Blue", "Black", "Brown", "Red"],
      price: 120,
      is_in_inventory: true,
      items_left: 3,
    ...
    // },
    {
      ...
      is_in_inventory: true,
      items_left: 3,
      imageURL: "https://assets.adidas.com/images/h_320,f_auto,q_auto:sensitive,fl_lossy/d0720712d81e42b1b30fa80800826447_9366/Stan_Smith_Shoes_Yellow_M20607_M20607_01_standard.jpg",
      slug: "stan-smith"
    },
    {
      id: 29,
    ...
    },
    {
      ...
      is_in_inventory: true,
      items_left: 3,
      imageURL: "https://assets.adidas.com/images/h_320,f_auto,q_auto:sensitive,fl_lossy/12365dbc7c424288b7cdab4900dc7099_9366/Superstar_Shoes_Yellow_FW3553_FW3553_01_standard.jpg",
      slug: "superstar"
    },
    {
      id: 26,
      ...
      is_in_inventory: false,
      items_left: 6,
      imageURL: "https://assets.adidas.com/images/h_320,f_auto,q_auto:sensitive,fl_lossy/ef901c7aeac042578eceab9d0159196c_9366/Nizza_x_Disney_Sport_Goofy_Shoes_Yellow_FW0651_01_standard.jpg",
      slug: "nizza-x-disney"
    },
    {
      id: 33,
  ...
  totalProdcutInStockCount = this.products.filter(p => p.is_in_inventory === true).length;
  totalProductInOutOfStock = this.products.filter(po => po.is_in_inventory === false).length;
